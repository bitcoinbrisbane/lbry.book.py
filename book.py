...
def upload(file_path, claim_id):
    ...
    #example in curl
    #curl -d'{"method": "publish", "params": {"name": "a-new-stream", "bid": "1.0", "file_path": "/home/lucascullen/GitHub/BitcoinBrisbane/lbry.book.py/267e5a93-478c-4c57-85b8-a1ebae8956d7.txt", "validate_file": false, "optimize_file": false, "channel_id": "cd31c8bb7a07e19b380d401a6792c12935c79692", "funding_account_ids": [], "preview": false, "blocking": false}}' http://localhost:5279/
    
    file_path = "/home/lucascullen/GitHub/BitcoinBrisbane/lbry.book.py/" + file_path
    print(file_path)

    payload = {
        'method': 'publish',
        'params': [{ 'name': '267e5a93-478c-4c57-85b8-a1ebae8956d7', 'bid': '1.0', 'file_path': file_path, 'validate_file': 'false', 'optimize_file': 'false', 'tags': [], 'languages': [], 'locations': [], 'channel_id': 'cd31c8bb7a07e19b380d401a6792c12935c79692', 'preview': 'false', 'blocking': 'false' }],
        'jsonrpc': '2.0',
        'id': 0
    }

    response = requests.post("http://localhost:5279", json={"method": "publish", "params": {"name": "267e5a93-478c-4c57-85b8-a1ebae8956d7", "bid": "1.0", "file_path": "/home/lucascullen/GitHub/BitcoinBrisbane/lbry.book.py/data/564fda54-4a9e-4b50-9a5a-65072341561a.json.txt", "validate_file": "false", "optimize_file": "false", "tags": [], "languages": [], "locations": [], "channel_id": "cd31c8bb7a07e19b380d401a6792c12935c79692", "preview": "false", "blocking": "false"}}).json()
...
upload(file_path, "cd31c8bb7a07e19b380d401a6792c12935c79692")
